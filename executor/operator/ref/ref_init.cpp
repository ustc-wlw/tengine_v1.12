...
extern void RegisterRefAxpyOps(void);// add by wanglw 20200426
extern void RegisterRefPoolingmaskOps(void); // add by wanglw 20200427

extern void RegisterRefRefineOutput(void); // add by wanglw 20200508
...
void RegisterRefOps(void)
{
    ...
    RegisterRefAxpyOps();// add by wanglw 20200426
    RegisterRefPoolingmaskOps(); // add by wanglw 20200427

    RegisterRefRefineOutput();// add by wanglw 20200508
}
