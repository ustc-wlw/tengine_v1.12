...
#include "operator/axpy.hpp" // add by wanglw 20200426
#include "operator/poolingmask.hpp" // add by wanglw 20200427

#include "operator/refinedet_output.hpp" // add by wanglw 20200508
...
int operator_plugin_init(void)
{
    ...
    RegisterOp<Axpy>("Axpy");// add by wanglw 20200423
    RegisterOp<Poolingmask>("Poolingmask");// add by wanglw 20200427
    RegisterOp<RefineOutput>("RefineOutput"); // add by wanglw 20200508
    return 0;
}